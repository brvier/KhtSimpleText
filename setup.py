...
setup(name='khtsimpletext',
      ...
      package_data = {'khtsimpletext': ['icons/*.png', 'syntax/*.xml', 'qml/*.js', 'qml/*.qml'],},
      ...
      'Maemo_Flags':'visible',
      'MeeGo_Desktop_Entry_Filename':'/usr/share/applications/installer-extra/khtsimpletext.desktop',
